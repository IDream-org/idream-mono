...
const SubSubCategoryItemsGalleryPage = () => {
  ...
  const [addPhoto] = useAddSubSubCategoryPhotoMutation();
  const [removePhoto] = useRemoveSubSubCategoryPhotoMutation();
...
export default SubSubCategoryItemsGalleryPage;
